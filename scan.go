...
// NewScan create new scan and return reference
func NewScan() *Scan {
	return &Scan{}
}

//Based off https://github.com/google/gopacket/blob/master/examples/arpscan/arpscan.go
func (s *Scan) run() {
...
func (s *Scan) scan(iface *net.Interface) error {
...
// pcap handle.
func (s *Scan) writeARP(handle *pcap.Handle, iface *net.Interface, addr *net.IPNet) error {
...
func (s *Scan) ips(n *net.IPNet) (out []net.IP) {
...
func (s *Scan) readARP(handle *pcap.Handle, iface *net.Interface, stop chan struct{}) {
